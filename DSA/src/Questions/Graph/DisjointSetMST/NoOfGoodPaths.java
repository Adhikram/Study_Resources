...
public class NoOfGoodPaths {
    int[] parent, count; // parent array to keep track of parent of each node and count array to keep
                         // track of number of nodes in each set
    ...
    private void union(int x, int y, int[] vals) {
        ...
        if (vals[parx] == vals[pary]) {
            // if the values of the parents of x and y are equal, update number of good
            // paths
    ...
    public static void main(String[] args) {
        ...
        NoOfGoodPaths noOfGoodPaths = new NoOfGoodPaths();
        System.out.println(noOfGoodPaths.numberOfGoodPaths(vals, edges));
    }
}
