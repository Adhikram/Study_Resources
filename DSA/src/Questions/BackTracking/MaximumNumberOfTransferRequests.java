 ...
 */
public class MaximumNumberOfTransferRequests {
    ...
    public int helper(int start, int[][] requests, int[] indegree, int n, int count) {
        ...
        // Backtracking to the older point
        indegree[requests[start][0]]++;
        indegree[requests[start][1]]--;
        // Not-take
    ...
    public static void main(String[] args) {
        MaximumNumberOfTransferRequests maximumNumberOfTransferRequests = new MaximumNumberOfTransferRequests();
        int[][] requests = { { 0, 1 }, { 1, 0 }, { 0, 1 }, { 1, 2 }, { 2, 0 }, { 3, 4 } };
        System.out.println(maximumNumberOfTransferRequests.maximumRequests(5, requests));
    }
}
