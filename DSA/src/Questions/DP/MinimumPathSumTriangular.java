...
public class MinimumPathSumTriangular {
    ...
    // programming
    static int solve(int i, int j, int[][] triangle, int n, int[][] dp) {
    ...
    // Function to find the minimum path sum in the triangle using dynamic
    // programming
    static int minSumPathOptimizedDP(int[][] triangle, int n) {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(minSumPathRecursive(triangle, n));
        System.out.println(minSumPathTabulation(triangle, n));
        System.out.println(minSumPathOptimizedDP(triangle, n));
    }
}
