 ...
 */
public class MaximumSubsequentScore {
    ...
    public static void main(String[] args) {
        MaximumSubsequentScore m = new MaximumSubsequentScore();
        int[] speed = {1, 3, 3, 2};
        int[] efficiency = {2, 1, 3, 4};
        int k = 3;
        System.out.println(m.maxScore(speed, efficiency, k));
    }
