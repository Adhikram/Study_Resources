...
# Key Components:
# - maximum_invitations(): Main implementation
# - dfs(): Helper for finding augmenting paths
# - Match and visited arrays tracking
"""


class MaximumNumberOfInvitation:
    def maximum_invitations(self, grid: list[list[int]]) -> int:
        ...
        def dfs(
            grid: list[list[int]], vis: list[bool], match: list[int], boy: int
        ) -> bool:
...
def main():
    solution = MaximumNumberOfInvitation()
